...
def lcd_backlight_on_3_seconds():
    global lcd_light_timer
    ...
    with lcd_lock:
        ...
        if lcd_light_timer:
            lcd_light_timer.cancel()

        lcd_light_timer = Timer(3.0, lcd_backlight_off)
        lcd_light_timer.start()
